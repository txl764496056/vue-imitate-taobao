...
const createProduct = function({product='',type=''}={product,type}){
    ...
    return Mock.mock({
        "search_list|8":[{
           ...
           /*  "spu_code":function(){
                let code = '';
               code = Mock.mock({"code":"@increment()"}).code;
                spu_code = 's' + code;
                return spu_code;
            }, */
                    ...
                    "color":{
                        ...
                        "list|4-6":[{
                            ...
                            "code":function(){
                                ...
                                color_list.push({code,img:this.img});
                                return code;
                            },
                            "value":"@ctitle(1,4)"+'色'
                        }]
                        ...
                        for(let j=0;j<size_list.length;j++){
                            ...
                            temp = Mock.mock({
                                "temp":{
                                    ...
                                    "code":spu_code+color_list[i].code+size_list[j].code,
                                }
                            }).temp;
                            result.push(temp);
                        }
...
/* function({product='',type=''}={product,type}){
    let shop_id_index = -1;
    let num = 0;
    let color_list = [];
    let spu_code = 's1';
